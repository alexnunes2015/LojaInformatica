...
<link rel='stylesheet' href="files/RemoverUser.css"></link>
</head>
...
<img id='Picture2' name='Picture2' src='files/removeruser_picture2.png' border='0' width='1276' height='106'></img></div>
...
<a href="vendas.php">
<img id='Picture1' name='Picture1' src='files/removeruser_picture1.png' border='0' width='126' height='41'></img></a></div>
...
<a href="produtos.php">
<img id='Picture3' name='Picture3' src='files/removeruser_picture3.png' border='0' width='136' height='41'></img></a></div>
...
<a href="gestao.php">
<img id='Picture4' name='Picture4' src='files/removeruser_picture4.png' border='0' width='126' height='41'></img></a></div>
...
<center>
Selecione o Utilizador a remover:
...
<?php
  ...
  $con=mysql_connect("sispicserver.no-ip.org","Grupo_2","7846");
	...
	if($contador==1)
	{
		echo '<script>alert("Só existe um utilizador no sistema, removendo-o não seria possivel aceder mais ao sistema!");</script>';
...
<br><bt>
<input type="submit" value="Remover Agora">
</center>
</form>
...
<img id='Picture5' name='Picture5' src='files/removeruser_picture5.png' border='0' width='1276' height='80'></img></div>
...
<img id='Picture6' name='Picture6' src='files/removeruser_picture6.png' border='0' width='56' height='37'></img></div>
...
<a href="logoff.php">
<img id='Picture7' name='Picture7' src='files/removeruser_picture7.png' border='0' width='51' height='37'></img></a></div>
...
<a href="gestao.php">
<img id='Picture8' name='Picture8' src='files/removeruser_picture8.png' border='0' width='51' height='35'></img></a></div>
</body>
